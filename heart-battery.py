...
class BatteryHeartAdvertisement(Advertisement):
...
def main():
    ...
    battery_heart_advertisement = BatteryHeartAdvertisement(bus, 0)
    ...
    ad_manager.RegisterAdvertisement(battery_heart_advertisement.get_path(), {},
